        ...
        {filteredItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-3xl font-body-md text-body-md transition-colors relative overflow-hidden cursor-pointer active:scale-[0.97] ${
                isActive
            ...
            >
              {isActive && (
                <div className="absolute inset-0 bg-primary-container rounded-3xl -z-10" />
              )}
